...
SECRET_KEY = 'django-insecure-*k)=8wl6(t)21_e*r*q7io#d#ti=j%q3yc$x*==$vlm989594w'
...
INSTALLED_APPS = [
    ...
    'journal_app',  # Добавляем наше приложение
]
...
STATIC_URL = '/static/'  # Исправляем путь до статических файлов
STATICFILES_DIRS = [
    BASE_DIR / "static",
]
